...
def plot_validation_suite(model, t_end=5.0, freq=1.0, Q_amp=100e-9, n_points=1000):
    ...
    ax1b.set_ylabel('C (nF)', color='#aaa', labelpad=10)
    ax1b.tick_params(colors='#aaa', pad=4)
    ax1.set_ylim(-0.05, 1.3)       # push x traces down, make room at top
    ax1b.set_ylim(model.Cmin*1e9 - 20, model.Cmax*1e9 + 80)  # explicit C range
